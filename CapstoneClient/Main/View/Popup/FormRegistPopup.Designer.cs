namespace Main.View.Popup
{
    partial class FormRegistPopup
    {
        ...
        private void InitializeComponent()
        {
			...
			this.tbName.KeyDown += new System.Windows.Forms.KeyEventHandler(this.FormRegistPopup_KeyDown);
			// 
			// tbClass
			// 
			...
			this.tbClass.KeyDown += new System.Windows.Forms.KeyEventHandler(this.FormRegistPopup_KeyDown);
			// 
			// lblClass
			// 
			...
			this.tbIP.KeyDown += new System.Windows.Forms.KeyEventHandler(this.FormRegistPopup_KeyDown);
			// 
			// lblIP
			// 
